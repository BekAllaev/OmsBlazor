...
namespace OMSBlazor.Client.Pages.Dashboard.OrderStastics
{
    public class OrderStasticsViewModel : ReactiveObject
    {
        ...
        public async Task OnNavigatedTo()
        {
            ...
            {
                throw new Exception($"Exception is thrown in the {nameof(this.OnNavigatedTo)} method of the {nameof(OrderStasticsViewModel)}", e);
            }
        }
        ...
        public async Task UpdateStastics()
        {
            ...
            {
                throw new Exception($"Exception is thrown in the {nameof(this.UpdateStastics)} method of the {nameof(OrderStasticsViewModel)}", e);
            }
        }
