...
[DependsOn(
    ...
    typeof(OMSBlazorTestBaseModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
    )]
public class OMSBlazorEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        var options = new DbContextOptionsBuilder<OMSBlazorDbContext>()
            .UseSqlite(connection)
            .Options;

        using (var context = new OMSBlazorDbContext(options))
        {
